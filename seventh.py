...
class Pawn(Piece):
    def possible_moves(self):
        """
        Vrací možné tahy pěšáka (pouze pohyb vpřed).
...
class Bishop(Piece):
    def possible_moves(self):
        """
        Vrací všechny možné tahy střelce (diagonály).
...
class Rook(Piece):
    def possible_moves(self):
        """
        Vrací všechny možné tahy věže (rovné linie).
...
class Queen(Piece):
    def possible_moves(self):
        """
        Vrací všechny možné tahy dámy (diagonály + rovné linie).
...
class King(Piece):
    def possible_moves(self):
        """
        Vrací všechny možné tahy krále (1 pole ve všech směrech).
